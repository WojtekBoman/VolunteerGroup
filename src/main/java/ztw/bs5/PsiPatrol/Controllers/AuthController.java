...
import ztw.bs5.PsiPatrol.Repositories.RoleRepository;
...
//    @Autowired
//    PracownikschroniskaRepository pracRepository;//testowanie
                ...
                switch (role) {
                    ...
                    case "pra":
                        Role modRole = roleRepository.findByName(ERole.ROLE_PRACOWNIK)
                                .orElseThrow(() -> new RuntimeException("Error: Role is not found."));
                        roles.add(modRole);
                     //   pracRepository.save(new Pracownikschroniska(user));//testowanie
